...
arcade.minesweeper.tile.prototype.is_a_mine_;
arcade.minesweeper.tile.prototype.is_revealed_;
arcade.minesweeper.tile.prototype.state;
arcade.minesweeper.tile.prototype.mine_count;
arcade.minesweeper.tile.prototype.element;

arcade.minesweeper.tile.prototype.is_a_mine = function() {
...
arcade.minesweeper.tile.prototype.get_element = function() {
  if(!this.element) {
    this.element = $.createElement("td").style({"width": 16, "height": 16, "background-image": "url('image/sprite.png')", "background-repeat": "no-repeat"});
    this.set_state("covered");
  }
  return this.element[0];
}

arcade.minesweeper.tile.prototype.reveal = function(force) {
...
arcade.minesweeper.tile.prototype.highlight = function() {
...
arcade.minesweeper.tile.prototype.unhighlight = function() {
  if(this.is_revealed()) return false;
  var state = this.get_state();
...
arcade.minesweeper.tile.prototype.mark = function() {
  if(this.is_revealed()) return false;
  var state = this.get_state();
...
arcade.minesweeper.tile.prototype.set_state = function(state) {
  this.state = state;
  switch(state) {
    case "covered":
...
arcade.minesweeper.tile.prototype.get_state = function() {
  return this.state;
}

arcade.minesweeper.tile.prototype.set_mine_count = function(mine_count) {
