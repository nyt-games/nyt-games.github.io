arcade.minesweeper.ssd = function(container, starting_value) {
  var div = $.createElement("div").style({"width": 39, "height": 23, "background-image": "url('image/sprite.png')", "background-repeat": "no-repeat", "background-position": "-46px -81px", "padding": 1, "margin": "auto"});
  var table = $.createElement("table").setAttribute({"cellspacing": 0, "cellpadding": 0});
  var tbody = $.createElement("tbody");
  var tr = $.createElement("tr");
  this.ssd_digits = [];
  for(var i = 0; i < 3; i++) {
    var digit = new arcade.minesweeper.ssd_digit();
...
arcade.minesweeper.ssd.prototype.set_value = function(value) {
...
arcade.minesweeper.ssd_digit = function() {}
arcade.minesweeper.prototype.element;
arcade.minesweeper.ssd_digit.prototype.get_element = function() {
  if(!this.element) {
    this.element = $.createElement("div").style({"width": 13, "height": 23, "background-image": "url('image/sprite.png')", "background-repeat": "no-repeat", "background-position": "0px -32px"});
  }
  return this.element;
}
arcade.minesweeper.ssd_digit.prototype.set_state = function(state) {
  switch(state) {
    case "0":
    case "1":
    case "2":
